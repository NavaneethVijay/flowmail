...
const chartData = [
  ...
  { month: "Thurs", desktop: 73, mobile: 190 },
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          This is the response time of the emails in the last 7 days
        </CardDescription>
      </CardHeader>
      <CardContent>
      ...
      <CardFooter className="flex-col items-start gap-2 text-sm">
        <div className="flex gap-2 font-medium leading-none">
          Your response time is 1.2 hours <TrendingUp className="h-4 w-4" />
        </div>
        <div className="leading-none text-muted-foreground">
          Showing response time for the last 7 days
        </div>
      </CardFooter>
    </Card>
  )
